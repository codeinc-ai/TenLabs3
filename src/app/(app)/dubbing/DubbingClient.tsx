    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-8 max-w-5xl mx-auto">
          ...
          {/* Recent Dubs Section */}
          <div>
            <h2 className="text-lg font-semibold text-black mb-6">Recent Dubs</h2>

            {/* Table Header */}
            <div className="grid grid-cols-[1fr_120px_140px_100px_80px] gap-4 px-4 py-3 text-xs font-medium text-gray-500">
              <div>Name</div>
              <div>Languages</div>
              <div>Status</div>
              <div>Created</div>
            ...
            <div className="divide-y divide-gray-100">
              {loading ? (
                ...
                dubbings.map((dub) => (
                  <div
                    key={dub._id}
                    className="grid grid-cols-[1fr_120px_140px_100px_80px] gap-4 px-4 py-4 items-center hover:bg-gray-50 transition-colors group"
                  >
                    <div className="text-sm text-gray-900 truncate" title={dub.projectName}>
                      {dub.projectName}
                    </div>
...
function StatusBadge({
  ...
  const config = {
    ...
    dubbing: { label: "Dubbing...", className: "bg-blue-100 text-blue-800" },
    dubbed: { label: "Done", className: "bg-green-100 text-green-800" },
