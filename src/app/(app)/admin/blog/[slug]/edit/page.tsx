      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-white/60 mt-1">Update &quot;{title}&quot;</p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              value={slug}
              disabled
              className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/[0.01] text-white/50 font-mono text-sm cursor-not-allowed"
            />
