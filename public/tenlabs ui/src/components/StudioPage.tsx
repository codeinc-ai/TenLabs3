    ...
    <main className="flex-1 flex flex-col h-screen bg-white min-w-0 overflow-hidden">
      ...
      <header className="h-16 border-b border-gray-100 flex items-center justify-between px-6 flex-shrink-0">
        <div className="flex items-center gap-3 text-black">
          ...
          <h1 className="font-medium">Studio</h1>
        </div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex border border-gray-200 rounded-lg overflow-hidden">
                <button
                  ...
                  className={`p-2.5 transition-colors ${viewMode === 'grid' ? 'bg-gray-100 text-black' : 'text-gray-400 hover:text-gray-600 hover:bg-gray-50'}`}>

                  <LayoutGrid size={18} />
                </button>
                <button
                  onClick={() => setViewMode('list')}
                  className={`p-2.5 transition-colors ${viewMode === 'list' ? 'bg-gray-100 text-black' : 'text-gray-400 hover:text-gray-600 hover:bg-gray-50'}`}>
...
}: {title: string;created: string;owner: string;}) {
  return (
